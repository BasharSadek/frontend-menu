...
const EditSubcategory = () => {
    ...
    useEffect(() => {
        // @ts-ignore
        axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/dashboard/subcategory/show/${id}`, {
            headers: {
            ...
            (response) => {
                setCategory_name(response.data.subcategory.category_name)
                setCategory_description(response.data.subcategory.category_description)
    ...
    const onSubmit = () => {
        ...
        // @ts-ignore
        axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/dashboard/subcategory/update/${id}`, formData, {
            headers: {
    ...
    return (
        <Box>
            ...
            <Header title="Edit Subcategory" subTitle="Here thce Subcategory is modified" />
